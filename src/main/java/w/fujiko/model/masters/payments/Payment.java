package w.fujiko.model.masters.payments;
...
public class Payment extends Defaults implements Serializable {
	
	private static final long serialVersionUID = -4324310097124479044L;
    ...
    @Column(name="deposit_method1_criteria_percentage", columnDefinition = "int")
    private Integer depositMethod1CriteriaPercentage;
    ...
    @Column(name="deposit_method2_criteria_percentage", columnDefinition = "int")
    private Integer depositMethod2CriteriaPercentage;
	...
	public Integer getDepositMethod1CriteriaPercentage() {
		return depositMethod1CriteriaPercentage;
	}

	public void setDepositMethod1CriteriaPercentage(Integer depositMethod1CriteriaPercentage) {
	...
	public Integer getDepositMethod2CriteriaPercentage() {
		return depositMethod2CriteriaPercentage;
	}

	public void setDepositMethod2CriteriaPercentage(Integer depositMethod2CriteriaPercentage) {
