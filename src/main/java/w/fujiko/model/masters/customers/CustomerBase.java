 ...
 */
@Entity
@Table(name="mst_cst_base")
public class CustomerBase extends Defaults implements Serializable {
	...
	@NotNull
    @Column(name="mst_cst_base_cd", columnDefinition = "varchar(7)", updatable = false)
    private String code;
    
    @NotNull
    @ManyToOne
    @JoinColumn(name="mst_cst_group_id", columnDefinition = "int", insertable=true,updatable=true)
	private CustomerGroup group;

	@NotNull
	@ManyToOne
    @JoinColumn(name="mst_billing_id", columnDefinition = "int", insertable=true,updatable=true)
	...
	@ManyToOne
	@NotNull
    @JoinColumn(name="jurisdiction", columnDefinition = "int", insertable=true,updatable=true,nullable=false)
    ...
    private Set<CustomerDepartment> customerDepartments=new HashSet<>();
	...
	public Set<CustomerDepartment> getCustomerDepartments() {
        return customerDepartments;
    }

    public void setCustomerDepartments(Set<CustomerDepartment> customerDepartments) {
