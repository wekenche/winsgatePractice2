package w.fujiko.model.transactions.sales.histories;
...
@Entity
@Table(name="trn_sales_detail_history")
public class SalesDetailHistory implements Serializable {
	...
	private SalesHeaderHistory salesHeader;
	
    @ManyToOne
    @NotNull
	@JoinColumn(name="quotation_slip_id", insertable=false, updatable=false, nullable=false)
	...
	public SalesHeaderHistory getSalesHeader() {
		return salesHeader;
	}

	public void setSalesHeader(SalesHeaderHistory salesHeader) {
