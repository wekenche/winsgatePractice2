package w.fujiko.service.transactions.quotations.histories;
...
@Service
public interface QuotationHeaderHistoryService extends UniversalCrud<QuotationHeaderHistory, Integer> {
