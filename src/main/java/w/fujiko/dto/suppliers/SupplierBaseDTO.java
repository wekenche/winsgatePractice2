...
public class SupplierBaseDTO implements Serializable {
	...
	private static final long serialVersionUID = 319934624992507466L;
	...
	private SupplierGroupDTO group;
	...
	public SupplierGroupDTO getGroup() {
		return group;
	}

	public void setGroup(SupplierGroupDTO group) {
		this.group = group;
	}
